...
![01-audiorecord-创建](./01-audiorecord-创建.png)

![02-audiorecord-创建](./02-audiorecord-创建.png)

AudioRecord 创建完成后开始录音

注意此处调用时需要判断当前的audiorecord的status， AudioRecord需要开启Manifest相关权限 
